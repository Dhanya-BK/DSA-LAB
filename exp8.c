...
void main()
{
	...
	switch(choice)
	{
		case 1:printf("Enter Emp ssn,Name,Department,Designation,Salary,Phone no\n");
		       scanf("%s%s%s%s%d%ld",ssn,name,dept,des,&salary,&ph);
		       create(ssn,name,dept,des,salary,ph);
		       break;
		case 2:display();
			break;
		case 3:printf("Enter Emp ssn,Name,Department,Designation,Salary,Phone no\n");
		       scanf("%s%s%s%s%d%ld",ssn,name,dept,des,&salary,&ph);
		       inbeg(ssn,name,dept,des,salary,ph);
		       break;
		case 4:printf("Enter Emp ssn,Name,Department,Designation,Salary,Phone no\n");
		       scanf("%s%s%s%s%d%ld",ssn,name,dept,des,&salary,&ph);
